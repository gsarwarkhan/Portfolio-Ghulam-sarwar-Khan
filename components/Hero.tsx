    ...
    return (
        ...
        >
            <div className="max-w-5xl mx-auto text-center z-10">
                {/* Profile Image */}
                <div className="relative inline-block mb-8" data-aos="zoom-in">
                    <div className="relative w-48 h-48 sm:w-56 sm:h-56 mx-auto">
                        <Image
                            ...
                            priority
                        />
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-60 h-60 sm:w-64 sm:h-64 rounded-full border-3 border-transparent bg-gradient-to-r from-primary to-accent animate-rotate" style={{ WebkitMaskComposite: "destination-out", maskComposite: "exclude" }} />
                    </div>
                </div>

                {/* Hero Text */}
                <div className="space-y-4" data-aos="fade-up">
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold bg-gradient-to-r from-white to-neutral-gray-light bg-clip-text text-transparent">
                        GHULAM SARWAR KHAN
                    </h1>
                    <h2 className="text-xl sm:text-2xl lg:text-3xl text-neutral-gray-light font-medium">
                        Secretary General, Pakistan Tea Association & AI Developer
                    </h2>
                    <p className="text-lg sm:text-xl font-display italic text-accent-light">
                        "Governance, Compliance & AI-Driven Leadership"
                    </p>
                    <p className="text-base sm:text-lg text-neutral-gray-light max-w-2xl mx-auto">
                        Leading national trade administration while pioneering AI integration in trade bodies
                    </p>
                </div>

                {/* Badges */}
                <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mt-8" data-aos="fade-up" data-aos-delay="200">
                    <span className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-primary/20 backdrop-blur-lg border border-white/10 text-white text-sm sm:text-base font-semibold hover:scale-105 transition-transform">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clipRule="evenodd" />
                        </svg>
                        Executive Leadership
                    </span>
                    <span className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-accent/20 backdrop-blur-lg border border-white/10 text-white text-sm sm:text-base font-semibold hover:scale-105 transition-transform">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 rounded-full bg-neutral-gray/20 backdrop-blur-lg border border-white/10 text-white text-sm sm:text-base font-semibold hover:scale-105 transition-transform">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                {/* Social Links */}
                <div className="mt-10 space-y-4" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <div className="flex justify-center gap-6 mt-6">
                        <h4 className="text-neutral-gray-light font-semibold text-sm sm:text-base">Connect With Me</h4>
                    </div>
