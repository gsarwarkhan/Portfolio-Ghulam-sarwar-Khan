        ...
        <section id="skills" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    {/* Technical Skills */}
                    <div>
                        <h3 className="text-2xl font-display font-bold text-slate-900 mb-6">Technical Skills</h3>
                    ...
                    {/* Professional Skills */}
                    <div>
                        <h3 className="text-2xl font-display font-bold text-slate-900 mb-6">Professional Skills</h3>
                        <div className="space-y-6">
