                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
                    ...
                    <div className="flex-1 text-center lg:text-left space-y-8" data-aos="fade-right">
                        <div className="space-y-4">
                            ...
                            <h1 className="text-2xl sm:text-3xl lg:text-5xl font-display font-black text-white leading-tight">
                                GHULAM SARWAR KHAN
                            </h1>
                        </div>
                        ...
                        <div className="max-w-2xl mx-auto lg:mx-0 space-y-4 text-neutral-gray-light leading-relaxed">
                            <p className="text-lg">
                                Facilitating national trade governance and institutional compliance while pioneering
                                <span className="text-white font-semibold"> AI-driven transformation</span> as a future-ready leader.
                            </p>
                        </div>
                    ...
                    <div className="relative" data-aos="fade-left">
                        <div className="relative w-56 h-56 sm:w-72 sm:h-72 lg:w-[320px] lg:h-[320px]">
                            ...
                            <div className="absolute -bottom-4 -left-4 bg-white dark:bg-slate-900 p-4 rounded-2xl shadow-2xl z-20 border border-slate-100 hidden sm:block">
                                ...
                                <div className="text-slate-500 text-xs font-semibold">Executive Support</div>
                            </div>
