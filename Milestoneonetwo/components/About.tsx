                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <ul className="space-y-1 text-slate-600 dark:text-slate-400 text-sm">
                                    <li>✓ 16+ years serving senior executives</li>
